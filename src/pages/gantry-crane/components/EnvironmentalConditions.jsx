...
const EnvironmentalConditions = ({ specs, onChange, errors }) => {
  ...
  const visibilityOptions = [
    ...
    { value: 'night', label: 'Night Operation' }
  ];
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-text-secondary">
          Maximum safe operating wind speed for outdoor operation
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-text-secondary">
          Operating temperature range for outdoor conditions
        </p>
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">
          Ground/Support Conditions <span className="text-error-500">*</span>
        </label>
        <Select
        ...
        />
        <p className="mt-1 text-xs text-text-secondary">
          Surface conditions for gantry operation
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-text-secondary">
          Environmental visibility factors affecting operation
        </p>
      </div>
      ...
      <div className="bg-secondary-50 border border-secondary-200 rounded-lg p-4 mt-6">
        ...
        <div className="text-xs text-secondary-700 space-y-1">
          <p>• Stop operation if wind speed exceeds 60 km/h</p>
          <p>• Avoid operation in poor visibility conditions</p>
          <p>• Ensure stable ground conditions before operation</p>
          <p>• Consider temperature effects on materials</p>
        </div>
      </div>
      
      {/* Outdoor Operation Notes */}
      <div className="bg-warning-50 border border-warning-200 rounded-lg p-4">
        <div className="flex items-center space-x-2 mb-2">
          <Icon name="AlertTriangle" size={16} className="text-warning-600" />
          <span className="text-sm font-medium text-warning-800">Outdoor Operation Notes</span>
        </div>
        <div className="text-xs text-warning-700 space-y-1">
          <p>• Gantry cranes are typically outdoor equipment</p>
          <p>• Wind resistance is critical for safety</p>
          <p>• Ground conditions must support heavy loads</p>
          <p>• Weather monitoring is essential</p>
        </div>
      </div>
    </div>
  );
